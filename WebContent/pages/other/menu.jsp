...
<link
	href="${pageContext.request.contextPath}/resources/css/pages/other/menu.css"
	rel="stylesheet">
</head>

<nav class="navbar navbar-dark hidden"
	...
	<div
		...
		<div
			...
			<div
				...
				<div class="d-flex align-items-center justify-content-center perfil" id="">
					<c:if test="${not empty user}">
						<span style="background-color: rgb(130, 53, 255)"
							...
							<a class="text-decoration-none" href="${pageContext.request.contextPath}/cadServlet?acao=abrir-editar">
							
							
							<p class="m-0 text-light">${nm_usuario}</p>
