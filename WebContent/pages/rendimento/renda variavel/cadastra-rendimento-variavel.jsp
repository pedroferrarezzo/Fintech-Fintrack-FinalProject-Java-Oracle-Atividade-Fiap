...
<body>
	...
	<div class="container mt-4">
		...
		<form action="${pageContext.request.contextPath}/rendServlet"
			method="post">
			<input type="hidden" value="cadastrar-variavel" name="acao">
			...
			<div class="form-group">
				<label for="nm_rendimento">Tipo do rendimento:</label> <select
					...
					required>
					<option class="disabled" value="" disabled>Renda Variavel</option>
