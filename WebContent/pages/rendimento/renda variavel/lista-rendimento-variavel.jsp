		...
		<table class="table table-dark table-hover">
			<thead>
				<tr>
					...
					<th class="text-center" scope="col">Quantidade Ativos</th>
					<th class="text-center" scope="col">Total Ativos</th>
					<th class="text-center" scope="col">Valor dividendos</th>
					<th class="text-center" scope="col">Total dividendos</th>
			...
			<tbody>
				<c:forEach items="${rendimentos}" var="d">
					<tr>
						...
						<td class="text-center">${d.getQtd_ativo()}x</td>
						<td class="text-center"><fmt:formatNumber type="currency" maxFractionDigits="3" value="${d.getVl_total_ativo()}"/></td>
						<td class="text-center"><fmt:formatNumber type="currency" maxFractionDigits="3" value="${d.getVl_dividendo()}"/></td>
						<td class="text-center"><fmt:formatNumber type="currency" maxFractionDigits="3" value="${d.getVl_total_dividendo()}"/></td>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<form action="${pageContext.request.contextPath}/rendServlet"
						...
						<input type="hidden" name="tipo_rendimento" value="Renda Variavel"> <input
